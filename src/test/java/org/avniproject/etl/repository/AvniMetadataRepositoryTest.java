...
public class AvniMetadataRepositoryTest extends BaseIntegrationTest {
    ...
    public void shouldGetConceptName() {
        ContextHolder.setContext(OrganisationIdentity.createForOrganisation("orgc", "orgc"));
    ...
    public void shouldLookForConceptNameWithinOrganisation() {
        ContextHolder.setContext(OrganisationIdentity.createForOrganisation("orgb", "orgb"));
